...
- Python 3.12+ required at runtime; mypy checks against `python_version = "3.12"` (pyproject), so modern typing syntax (builtin generics like `dict[str, str]`, `X | None`) is fine in type-checked code.
